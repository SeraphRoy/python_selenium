...
while 1:
    ...
    login.click()
    MyClassSchedule = browser.find_element_by_id('ct105')
    MyClassSchedule.click()
    Switch154 = browser.find_element_by_id('pageContent_CourseList_SwitchCourseButton_1')
    Switch154.click()
    isSuccessful = SwitchTo('pageContent_ClassScheduleUC_dl_coursegroup_PrimarySections_0_SecondarySections_0_SwitchLinkSecondary_2') or SwitchTo('pageContent_ClassScheduleUC_dl_coursegroup_PrimarySections_0_SecondarySections_0_SwitchLinkSecondaryAlt_3')
